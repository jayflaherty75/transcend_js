...
//-----------------------------------------------------------------------------
Core._("Helpers").register ("MD5", new (Class.create ( /** @lends MD5Helpers# */ {
	/**
	 * @class Helper functions for MD5 encryption
	 * @constructs
	 */
	initialize: function () {
		var core_md5;
		...
		//--------------------------------------------------------------------
		/**
		 * @name MD5Helpers#hex_md5
		 * @function
		 * @param {string} s String to be encrypted
		 * @return MD5 hash of given string
		 * @type string
		 */
		this.hex_md5 = function (s){ return binl2hex(core_md5(str2binl(s), s.length * this.chrsz));};

		//--------------------------------------------------------------------
		/**
		 * @name MD5Helpers#b64_md5
		 * @function
		 * @param {string} s String to be encrypted
		 * @return MD5 hash of given string
		 * @type string
		 */
		this.b64_md5 = function (s){ return binl2b64(core_md5(str2binl(s), s.length * this.chrsz));};

		//--------------------------------------------------------------------
		/**
		 * @name MD5Helpers#str_md5
		 * @function
		 * @param {string} s String to be encrypted
		 * @return MD5 hash of given string
		 * @type string
		 */
		this.str_md5 = function (s){ return binl2str(core_md5(str2binl(s), s.length * this.chrsz));};

		//--------------------------------------------------------------------
		/**
		 * @name MD5Helpers#hex_hmac_md5
		 * @function
		 * @param {string} key
		 * @param {string} data
		 * @return MD5 hash of given string
		 ...
		 * @name MD5Helpers#test
		 * @function
		 * @return True if VM is working
		 * @type boolean
		 */
		this.test = function () {
