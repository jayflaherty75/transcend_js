//-----------------------------------------------------------------------------
/**
 * @fileoverview Reference class implementation.
 * 
 * Copyright &copy; 2011 
...
//-----------------------------------------------------------------------------
Core.register ("Reference", (function () {
...
(function () {
	...
	var test = function () {
		...
		var test_obj = { test: "Jason Flaherty", /** @ignore */ foo: function (arg1, arg2) {
		...
		var test_obj2 = { /** @ignore */ method: function (arg1) {
			return arg1;
		}};
		...
		var test_obj5 = { /** @ignore */ method: function (arg1) {
			if (arg1 === true)
				return test_obj;
			else
				return null;
